...
public class PredefinedImage<V> extends Expr<V> {
    ...
    public static enum PredefinedImageNames {
        ...
        TRIANGLE( "0,0,0,0,0\\n" //
            ...
            + "255,255,255,255,255\\n"
            + "0,0,0,0,0\\n" ),
        TRIANGLE_LEFT( "255,0,0,0,0\\n" //
            + "255,255,0,0,0\\n"
            + "255,0,255,0,0\\n"
            + "255,0,0,255,0\\n"
            + "255,255,255,255,255\\n" ),
        CHESSBOARD( "0,255,0,255,0\\n" //
            + "255,0,255,0,255\\n"
            + "0,255,0,255,0\\n"
            + "255,0,255,0,255\\n"
            + "0,255,0,255,0\\n" ),
        DIAMOND( "0,0,255,0,0\\n" //
            ...
            + "0,255,0,255,0\\n"
            + "0,0,255,0,0\\n" ),
        DIAMOND_SMALL( "0,0,0,0,0\\n" //
            + "0,0,255,0,0\\n"
            + "0,255,0,255,0\\n"
            + "0,0,255,0,0\\n"
            + "0,0,0,0,0\\n" ),
        SQUARE( "255,255,255,255,255\\n" //
            + "255,0,0,0,255\\n"
            + "255,0,0,0,255\\n"
            + "255,0,0,0,255\\n"
            + "255,255,255,255,255\\n" ),
        SQUARE_SMALL( "0,0,0,0,0\\n" //
            + "0,255,255,255,0\\n"
            + "0,255,0,255,0\\n"
            + "0,255,255,255,0\\n"
            + "0,0,0,0,0\\n" ),
        RABBIT( "255,0,255,0,0\\n" //
            + "255,0,255,0,0\\n"
            + "255,255,255,255,0\\n"
            + "255,255,0,255,0\\n"
            + "255,255,255,255,0\\n" ),
        COW( "255,0,0,0,255\\n" //
            ...
            + "0,255,255,255,0\\n"
            + "0,0,255,0,0\\n" ),
        MUSIC_CROTCHET( "0,0,255,0,0\\n" //
            + "0,0,255,0,0\\n"
            + "0,0,255,0,0\\n"
            + "255,255,255,0,0\\n"
            + "255,255,255,0,0\\n" ),
        MUSIC_QUAVER( "0,0,255,0,0\\n" //
            + "0,0,255,255,0\\n"
            + "0,0,255,0,255\\n"
            + "255,255,255,0,0\\n"
            + "255,255,255,0,0\\n" ),
        MUSIC_QUAVERS( "0,255,255,255,255\\n" //
            + "0,255,0,0,255\\n"
            + "0,255,0,0,255\\n"
            + "255,255,0,255,255\\n"
            + "255,255,0,255,255\\n" ),
        PITCHFORK( "255,0,255,0,255\\n" //
            + "255,0,255,0,255\\n"
            + "255,255,255,255,255\\n"
            + "0,0,255,0,0\\n"
            + "0,0,255,0,0\\n" ),
        ...
        TARGET( "0,0,255,0,0\\n" //
            ...
            + "0,255,255,255,0\\n"
            + "0,0,255,0,0\\n" ),
        TSHIRT( "255,255,0,255,255\\n" //
            + "255,255,255,255,255\\n"
            + "0,255,255,255,0\\n"
            + "0,255,255,255,0\\n"
            + "0,255,255,255,0\\n" ),
        ROLLERSKATE( "0,0,0,255,255\\n" //
            + "0,0,0,255,255\\n"
            + "255,255,255,255,255\\n"
            + "255,255,255,255,255\\n"
            + "0,255,0,255,0\\n" ),
        ...
        TORTOISE( "0,0,0,0,0\\n" //
            ...
            + "0,255,0,255,0\\n"
            + "0,0,0,0,0\\n" ),
        BUTTERFLY( "255,255,0,255,255\\n" //
            + "255,255,255,255,255\\n"
            + "0,0,255,0,0\\n"
            + "255,255,255,255,255\\n"
            + "255,255,0,255,255\\n" ),
        STICKFIGURE( "0,0,255,0,0\\n" //
            + "255,255,255,255,255\\n"
            + "0,0,255,0,0\\n"
            + "0,255,0,255,0\\n"
            + "255,0,0,0,255\\n" ),
        GHOST( "255,255,255,255,255\\n" //
            + "255,0,255,0,255\\n"
            + "255,255,255,255,255\\n"
            + "255,255,255,255,255\\n"
            + "255,0,255,0,255\\n" ),
        SWORD( "0,0,255,0,0\\n" //
            ...
            + "0,255,255,255,0\\n"
            + "0,0,255,0,0\\n" ),
        GIRAFFE( "255,255,0,0,0\\n" //
            + "0,255,0,0,0\\n"
            + "0,255,0,0,0\\n"
            + "0,255,255,255,0\\n"
            + "0,255,0,255,0\\n" ),
        SKULL( "0,255,255,255,0\\n" //
            + "255,0,255,0,255\\n"
            + "255,255,255,255,255\\n"
            + "0,255,255,255,0\\n"
            + "0,255,255,255,0\\n" ),
        UMBRELLA( "0,255,255,255,0\\n" //
            + "255,255,255,255,255\\n"
            + "0,0,255,0,0\\n"
            + "255,0,255,0,0\\n"
            + "0,255,255,0,0\\n" ),
    ...
    protected V accept(AstVisitor<V> visitor) {
        return ((MbedAstVisitor<V>) visitor).visitPredefinedImage(this);
    }
