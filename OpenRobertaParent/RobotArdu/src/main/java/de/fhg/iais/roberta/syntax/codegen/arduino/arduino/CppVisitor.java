...
public class CppVisitor extends ArduinoVisitor implements ArduinoAstVisitor<Void> {
    ...
    public Void visitHumiditySensor(HumiditySensor<Void> humiditySensor) {
        //TODO: temperatutre and humidity modes
    ...
    public Void visitRfidSensor(RfidSensor<Void> rfidSensor) {
        //TODO: presence and serial number modes. Add a lib function that would read the code
        this.sb.append("rob.rfidSerial(_mfrc522_" + rfidSensor.getPort().getPortNumber() + ")");
        return null;
    }
